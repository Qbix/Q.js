...
$jscomp.polyfill=function(a,c,e,l){if(c){e=$jscomp.global;a=a.split(".");for(l=0;l<a.length-1;l++){var m=a[l];m in e||(e[m]={});e=e[m]}a=a[a.length-1];l=e[a];c=c(l);c!=l&&null!=c&&$jscomp.defineProperty(e,a,{configurable:!0,writable:!0,value:c})}};
$jscomp.polyfill("String.prototype.startsWith",function(a){return a?a:function(a,e){var c=$jscomp.checkStringArgs(this,a,"startsWith");a+="";var m=c.length,r=a.length;e=Math.max(0,Math.min(e|0,c.length));for(var p=0;p<r&&e<m;)if(c[e++]!=a[p++])return!1;return p>=r}},"es6","es3");
$jscomp.polyfill("String.prototype.endsWith",function(a){return a?a:function(a,e){var c=$jscomp.checkStringArgs(this,a,"endsWith");a+="";void 0===e&&(e=c.length);e=Math.max(0,Math.min(e|0,c.length));for(var m=a.length;0<m&&0<e;)if(c[--e]!=a[--m])return!1;return 0>=m}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
...
$jscomp.iteratorFromArray=function(a,c){$jscomp.initSymbolIterator();a instanceof String&&(a+="");var e=0,l={next:function(){if(e<a.length){var m=e++;return{value:c(m,a[m]),done:!1}}l.next=function(){return{done:!0,value:void 0}};return l.next()}};l[Symbol.iterator]=function(){return l};return l};$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
